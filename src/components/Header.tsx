...
const Header: React.FC<HeaderProps> = ({ setPage, isPreview = false }) => {
  const { appData, theme, isDarkMode, toggleDarkMode } = useAppContext();
  const { logoUrl, businessName, tagline } = appData ?? {};
            ...
            <div className="flex items-center justify-between gap-4">
                ...
                >
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <button onClick={() => setIsMenuOpen(true)} className="md:hidden p-2 rounded-full hover:bg-black/10 dark:hover:bg-white/10" aria-label="Open menu">
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
