  ...
  if (service.layout === 'compact') {
    return (
      ...
      >
        ...
        {service.photoUrl ? (
          <img src={service.photoUrl} alt={service.name} className="w-16 h-16 object-cover rounded-lg flex-shrink-0" loading="lazy" decoding="async" />
        ) : (
  ...
  return (
    ...
    >
      <div className="relative">
        {service.photoUrl && <img src={service.photoUrl} alt={service.name} className="w-full h-48 object-cover" loading="lazy" decoding="async" />}
        {service.promotion && (
            <div 
